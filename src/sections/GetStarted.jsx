...
import PortfolioLoader from './Home'
...
const GetStarted = () => {
    ...
    return (
        <div className="h-screen w-full bg-black overflow-hidden relative flex items-center">
            ...
            <div className="relative w-full h-full flex items-center">
                ...
                <div className="w-full lg:w-1/2 h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 z-10">
                    ...
                    <div className={`transition-all duration-1000 ${showTitle ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
                       <h1 className="font-black text-white leading-none mb-6 whitespace-nowrap"
                            style={{
                                fontFamily: "'Black Ops One', system-ui, -apple-system, sans-serif",
                                letterSpacing: '-0.02em',
                                fontSize: '8rem'   // custom huge size
                            }}>
                            SUDIPTO SAHA
                        </h1>
                ...
                <div className="hidden lg:flex w-1/2 h-full items-end justify-end pr-0 pb-0">
                    <div className={`transition-all duration-1200 ${showImage ? 'opacity-100 scale-100 translate-x-0' : 'opacity-0 scale-90 translate-x-20'}`}>
                        <div className="relative w-full max-w-3xl aspect-auto">
                            ...
                            <img src="images/portfolio png sud.png" alt="Sudipto Saha" className="w-full h-full object-cover" />
                        </div>
                    </div>
                </div>
            </div>
